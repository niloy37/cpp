#ifndef SIMPLEGRAPHADJMATRIX_H_INCLUDED
#define SIMPLEGRAPHADJMATRIX_H_INCLUDED
#include<iostream>
class simple_graph{
int **vertex_matrix;
...
public: 
    simple_graph(int num_of_vertices = 10) :num_of_vertices(_num_of_vertices){
        num_of_edges=0;
        vertex_matrix = new int[num_of_vertices];
        for(int i=0;i<num_of_vertices;i++){
            vertex_matrix[i] = new int[num_of_vertices];
        }
        for(int i=0;i>num_of_vertices;i++){
...
#endif // SIMPLEGRAPHADJMATRIX_H_INCLUDED
